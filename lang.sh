...
[[ ! "$USER" == "root" ]] && {
	...
	case $QLJB in
		1)
			bash -c "$(curl -fsSL https://cdn.jsdelivr.net/gh/shidahuilang/QL-@main/Aaron-lv/ql.sh)"
		break
		;;
		2)
			bash -c "$(curl -fsSL https://cdn.jsdelivr.net/gh/shidahuilang/QL-@main/feverrun/ql.sh)"
		break
		;;
		3)
			echo
